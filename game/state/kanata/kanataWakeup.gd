...
#func wakeup_buffer(state: Dictionary, interpreter: InputInterpreter) -> void:
		...
		#
	#elif (level_3_OK(state) and interpreter.special_input_button(Enums.SpecialInput.M63214, Enums.InputFlags.CDown, state[Enums.StKey.leftface])):
	...
	#elif (interpreter.special_input_button(Enums.SpecialInput.M214Strict, Enums.InputFlags.CDown, state[Enums.StKey.leftface])):
		#state[Enums.StKey.cancelState] = "KanataWingStance"
	#elif (interpreter.special_input_button(Enums.SpecialInput.M214Strict, Enums.InputFlags.BDown, state[Enums.StKey.leftface])):
		#state[Enums.StKey.cancelState] = "KanataWingStance"
	#elif (interpreter.special_input_button(Enums.SpecialInput.M214Strict, Enums.InputFlags.ADown, state[Enums.StKey.leftface])):
		#state[Enums.StKey.cancelState] = "KanataWingStance"
		#
