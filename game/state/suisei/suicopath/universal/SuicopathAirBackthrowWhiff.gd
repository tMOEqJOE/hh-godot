...
class_name SuicopathAirBackThrowWhiffState
...
func _init():
	...
	anim_data = {
		...
		1 : {
			...
			Enums.StKey.Hit1PosX : 0, Enums.StKey.Hit1PosY : -27852800,
			Enums.StKey.Hit1ScaleX : 850932, Enums.StKey.Hit1ScaleY : 182460,
...
func reaction(state: Dictionary, interpreter: InputInterpreter,event_cause: int) -> void:
	...
	if (event_cause == Enums.Reaction.ThrowHit):
		change_state.call("AngelAirBackThrowHit")
