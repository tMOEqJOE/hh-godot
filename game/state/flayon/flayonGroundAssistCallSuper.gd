extends FlayonGroundAssistCallState

class_name FlayonGroundAssistCallSuperState

func _init():
	CallSound = preload("res://game/assets/voice/flayon/mxf_I've been waiting for this2.wav")
