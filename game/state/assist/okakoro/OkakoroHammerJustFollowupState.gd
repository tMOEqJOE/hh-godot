...
class_name OkakoroHammerJustFollowupState
...
func _init():
	...
	anim_data = {
		...
		8 : {
			...
			Enums.StKey.Hit1PosX : 4111807, Enums.StKey.Hit1PosY : -17170434,
			Enums.StKey.Hit1ScaleX : 1330702, Enums.StKey.Hit1ScaleY : 1849446,
