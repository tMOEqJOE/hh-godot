extends "res://game/state/assist/hakka/HakkaAssistAirGuardCancelAttackState.gd"

class_name HakkaAssistAirWeakGuardCancelAttackState
...
func _init():
	...
	anim_data = {
		...
		9 : {
			...
			Enums.StKey.Hit1PosX : 0, Enums.StKey.Hit1PosY : -12582913,
